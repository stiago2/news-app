...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"news-dashboard-container\">\n  <div class=\"card-deck\">\n    <app-news-card\n      *ngFor=\"let n of news\"\n      [news]=\"n\"\n      (onEdit)=\"edit($event)\"\n      (onDelete)=\"delete($event)\"\n    ></app-news-card>\n  </div>\n</div>\n");
...
/* harmony import */ var _shared_Services_notification_center_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @shared/Services/notification-center.service */ "./src/app/shared/Services/notification-center.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var app_news_Services_news_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/news/Services/news-api.service */ "./src/app/news/Services/news-api.service.ts");
/* harmony import */ var app_news_Validators_title_length_validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/news/Validators/title-length.validator */ "./src/app/news/Validators/title-length.validator.ts");
...
let AddNewsComponent = class AddNewsComponent {
        ...
        this.newsForm = this.formBuilder.group({
            title: [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern("^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$")
                ])
            ],
    ...
    onDelete() {
        const settings = {
            message: `You are about to delete ${this.newsForm.get("title").value}, do you want to continue?`,
            title: "Delete News"
        };
...
AddNewsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-news.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/news/Components/add-news/add-news.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-news.component.less */ "./src/app/news/Components/add-news/add-news.component.less")).default]
    })
], AddNewsComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var app_news_Services_news_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/news/Services/news-api.service */ "./src/app/news/Services/news-api.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _shared_Services_notification_center_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @shared/Services/notification-center.service */ "./src/app/shared/Services/notification-center.service.ts");
...
DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dashboard.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/news/Components/dashboard/dashboard.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./dashboard.component.less */ "./src/app/news/Components/dashboard/dashboard.component.less")).default]
    })
], DashboardComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var app_news_Models_Colors_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/news/Models/Colors.enum */ "./src/app/news/Models/Colors.enum.ts");
...
], NewsCardComponent.prototype, "onDelete", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], NewsCardComponent.prototype, "onEdit", void 0);
NewsCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-news-card",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./news-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/news/Components/news-card/news-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./news-card.component.less */ "./src/app/news/Components/news-card/news-card.component.less")).default]
    })
], NewsCardComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _Models_News_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Models/News.class */ "./src/app/news/Models/News.class.ts");
...
AdapterService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _adapter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./adapter.service */ "./src/app/news/Services/adapter.service.ts");
...
let NewsApiService = class NewsApiService {
    ...
    createNews(news) {
        news.id = null;
        return this.http.post(`${this.BASE_URL}`, news);
    }
    updateNews(news) {
        return this.http.put(`${this.BASE_URL}/${news.id}`, news);
    }
    getNewsById(id) {
        if (id === 0) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((data) => this.adapter.adapt(data)));
    }
    getNews() {
        return this.http
            .get(this.BASE_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(data => data.map(item => this.adapter.adapt(item))));
    }
    getNewsCategories() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ValidateTitleLength", function() { return ValidateTitleLength; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _Components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/dashboard/dashboard.component */ "./src/app/news/Components/dashboard/dashboard.component.ts");
/* harmony import */ var _Components_add_news_add_news_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/add-news/add-news.component */ "./src/app/news/Components/add-news/add-news.component.ts");
/* harmony import */ var _core_Guards_can_deactivate_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @core/Guards/can-deactivate.guard */ "./src/app/core/Guards/can-deactivate.guard.ts");
...
/* harmony import */ var _Components_add_news_add_news_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/add-news/add-news.component */ "./src/app/news/Components/add-news/add-news.component.ts");
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _Components_news_card_news_card_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/news-card/news-card.component */ "./src/app/news/Components/news-card/news-card.component.ts");
...
NewsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _news_routing_module__WEBPACK_IMPORTED_MODULE_2__["NewsRoutingModule"].routedComponents,
            _Components_add_news_add_news_component__WEBPACK_IMPORTED_MODULE_3__["AddNewsComponent"],
            _Components_news_card_news_card_component__WEBPACK_IMPORTED_MODULE_5__["NewsCardComponent"]
        ],
...
/* harmony import */ var _shared_notification_modal_notification_modal_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @shared/notification-modal/notification-modal.component */ "./src/app/shared/notification-modal/notification-modal.component.ts");
...
NotificationCenterService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: "root"
    })
